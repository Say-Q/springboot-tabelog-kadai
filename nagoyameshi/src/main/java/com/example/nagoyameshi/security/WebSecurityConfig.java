		...
		http
				.authorizeHttpRequests((requests) -> requests
						.requestMatchers("/css/**", "/images/**", "/js/**", "/storage/**", "/", "/signup/**", "/shops",
								"/shops/{id}", "/company/**")
						.permitAll() //すべてのユーザーにアクセスを許可するＵＲＬ
						.requestMatchers("/admin/**").hasRole("ADMIN") //管理者にのみアクセスを許可するURL
						.requestMatchers("/company/**").hasRole("PAYMEMBER") //有料会員のみアクセスを許可するURL
						.requestMatchers("/company/**").hasRole("FREEMEMBER") //無料会員のみアクセスを許可するURL
